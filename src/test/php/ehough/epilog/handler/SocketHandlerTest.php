 ...
 */
class ehough_epilog_handler_SocketHandlerTest extends ehough_epilog_TestCase
{
    /**
     * @var ehough_epilog_handler_SocketHandler
     */
    private $handler;
    ...
    {
        $this->handler = new ehough_epilog_handler_SocketHandler($connectionString);
        $this->handler->setFormatter($this->getIdentityFormatter());
    }

    private function writeRecord($string)
    {
        $this->handler->handle($this->getRecord(ehough_epilog_Logger::WARNING, $string));
    }
