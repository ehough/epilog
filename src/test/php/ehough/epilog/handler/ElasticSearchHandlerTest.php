...
class ElasticSearchHandlerTest extends ehough_epilog_TestCase
{
    /**
     * @var Elastica\Client mock
     */
    protected $client;
    ...
    public function testHandle()
    {
        ...
        $formatter = new ehough_epilog_formatter_ElasticaFormatter($this->options['index'], $this->options['type']);
        ...
        // perform tests
        $handler = new ehough_epilog_handler_ElasticSearchHandler($this->client, $this->options);
        $handler->handle($msg);
        $handler->handleBatch(array($msg));
    }

    /**
     * @covers ehough_epilog_handler_ElasticSearchHandler::setFormatter
     */
    public function testSetFormatter()
    {
        $handler = new ehough_epilog_handler_ElasticSearchHandler($this->client);
        $formatter = new ehough_epilog_formatter_ElasticaFormatter('index_new', 'type_new');
        $handler->setFormatter($formatter);
        $this->assertInstanceOf('ehough_epilog_formatter_ElasticaFormatter', $handler->getFormatter());
