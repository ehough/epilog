...
class LineFormatterTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $formatter = new ehough_epilog_formatter_LineFormatter("[%datetime%] %channel%.%level_name%: %message% %context% %extra.file% %extra%\n", 'Y-m-d');
        $message = $formatter->format(array(
            'level_name' => 'ERROR',
            'channel' => 'meh',
            'context' => array(),
    ...
    public function testDefFormatWithObject()
    {
        ...
        $this->assertEquals('['.date('Y-m-d').'] meh.ERROR: foobar [] {"foo":"[object] (TestFoo: {\\"foo\\":\\"foo\\"})","bar":"[object] (TestBar: {})","baz":[],"res":"[resource]"}'."\n", $message);
    }
    ...
    {
        $formatter = new ehough_epilog_formatter_LineFormatter(null, 'Y-m-d', true);
        $message = $formatter->format(
            array(
                'message' => "foo\nbar",
                'context' => array(),
