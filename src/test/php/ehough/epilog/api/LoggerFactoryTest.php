...
class ehough_epilog_impl_LoggerFactoryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testNoHandlers()
    {
        ...
        $this->assertTrue($logger instanceof ehough_epilog_impl_StandardLogger);

        $handler = $logger->popHandler();

        $this->assertTrue($handler instanceof ehough_epilog_impl_handler_NullHandler);
    }

    public function testSetHandlers()
    {
        ehough_epilog_api_LoggerFactory::setHandlerStack(array(new ehough_epilog_impl_handler_NullHandler()));
        ehough_epilog_api_LoggerFactory::setProcessorStack(array(new ehough_epilog_impl_processor_MemoryUsageProcessor()));
        ...
        $this->assertTrue($proc instanceof ehough_epilog_impl_processor_MemoryUsageProcessor);
    }
}