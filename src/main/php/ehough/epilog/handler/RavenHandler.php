...
class ehough_epilog_handler_RavenHandler extends ehough_epilog_handler_AbstractProcessingHandler
{
    ...
    /**
     * @var ehough_epilog_formatter_LineFormatter The formatter to use for the logs generated via handleBatch()
     */
    ...
    public function handleBatch(array $records)
    {
        ...
        $records = array_filter($records, array($this, '__callbackHandleBatchLevelFilter'));
        ...
        $record = array_reduce($records, array($this, '__callbackHandleBatchMaxSeverity'));
     ...
     */
    public function setBatchFormatter(ehough_epilog_formatter_FormatterInterface $formatter)
    {
    ...
    public function __callbackHandleBatchLevelFilter($record)
    {
