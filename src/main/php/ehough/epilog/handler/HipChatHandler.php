 ...
 */
class ehough_epilog_handler_HipChatHandler extends ehough_epilog_handler_SocketHandler
{
    /**
    ...
    {
        switch (true) {
            case $level >= ehough_epilog_Logger::ERROR:
                return 'red';
            case $level >= ehough_epilog_Logger::WARNING:
                return 'yellow';
            case $level >= ehough_epilog_Logger::INFO:
                return 'green';
            case $level == ehough_epilog_Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
    ...
    private function validateName($name)
    {
        if (function_exists('mb_strlen')) {
            return (mb_strlen($name) <= self::MAXIMUM_NAME_LENGTH);
        }

        return (strlen($name) <= self::MAXIMUM_NAME_LENGTH);
    }
}
